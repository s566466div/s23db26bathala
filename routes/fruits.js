...
router.get('/detail',secured,fruits_controllers.fruits_view_one_Page);
/* GET create fruits page */
router.get('/create',secured, fruits_controllers.fruits_create_Page);
/* GET create update page */
router.get('/update',secured, fruits_controllers.fruits_update_Page);
/* GET delete Fruits page */
router.get('/delete',secured, fruits_controllers.fruits_delete_Page);
